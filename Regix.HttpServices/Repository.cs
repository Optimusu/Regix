...
public class Repository : IRepository
{
    ...
    public async Task<HttpResponseWrapper<ArchivoDescargaDto>> GetDownloadUrlAsync(string container, string file, string nameOriginal)
    {
        ...
        if (responseHttp.IsSuccessStatusCode)
        {
            ...
            var dto = JsonSerializer.Deserialize<ArchivoDescargaDto>(json, _jsonOptions);
            return new HttpResponseWrapper<ArchivoDescargaDto>(dto!, false, responseHttp);
        }

        return new HttpResponseWrapper<ArchivoDescargaDto>(default!, true, responseHttp);
    }
