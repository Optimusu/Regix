...
namespace Regix.AppFront.Pages.EntitiesGen.DocumentTypePage;
...
public partial class EditDocumentType
{
    ...
    private const string BaseView = "/documentTypes";
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        _documentType = responseHttp.Response;
    }

    private async Task Edit()
    {
        var responseHttp = await _repository.PutAsync($"{BaseUrl}", _documentType);
