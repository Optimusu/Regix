...
public partial class IndexEtniaraza
{
    ...
    public List<EtniaRaza>? EtniaRazas { get; set; }
    ...
    private async Task Cargar(int page = 1)
    {
        ...
        var responseHttp = await _repository.GetAsync<List<EtniaRaza>>(url);
    ...
    private async Task ShowModalAsync(int id = 0, bool isEdit = false)
    {
        if (isEdit)
        {
            ...
            await _modalService.ShowAsync<EditEtniaraza>(parameters);
        }
        else
        {
            var parameters = new Dictionary<string, object>
            ...
            await _modalService.ShowAsync<CreateEtniaraza>(parameters);
        }
    }
