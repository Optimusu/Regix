...
public partial class IndexAnticonception
{
    ...
    public List<Anticonception>? Anticonceptions { get; set; }
    ...
    private async Task Cargar(int page = 1)
    {
        ...
        var responseHttp = await _repository.GetAsync<List<Anticonception>>(url);
    ...
    private async Task ShowModalAsync(int id = 0, bool isEdit = false)
    {
        if (isEdit)
        {
            ...
            await _modalService.ShowAsync<EditAnticonception>(parameters);
        }
        else
        {
            var parameters = new Dictionary<string, object>
            ...
            await _modalService.ShowAsync<CreateAnticonception>(parameters);
        }
    }
