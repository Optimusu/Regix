...
public partial class CreateAnticonception
{
    //Services
    ...
    private Anticonception Anticonception = new() { Active = true };
    private string BaseUrl = "/api/v1/anticonceptions";
    private string BaseView = "/anticonceptions";

    private async Task Create()
    {
        var responseHttp = await _repository.PostAsync($"{BaseUrl}", Anticonception);
