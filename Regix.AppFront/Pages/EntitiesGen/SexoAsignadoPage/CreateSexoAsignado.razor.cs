...
public partial class CreateSexoAsignado
{
    //Services
    ...
    private SexoAsignado SexoAsignados = new() { Active = true };
    private string BaseUrl = "/api/v1/sexoasignados";
    private string BaseView = "/sexoasignados";

    private async Task Create()
    {
        var responseHttp = await _repository.PostAsync($"{BaseUrl}", SexoAsignados);
