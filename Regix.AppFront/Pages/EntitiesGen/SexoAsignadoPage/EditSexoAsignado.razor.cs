...
public partial class EditSexoAsignado
{
    //Services
    ...
    private SexoAsignado? SexoAsignados;
    private const string BaseUrl = "/api/v1/sexoasignados";
    private const string BaseView = "/sexoasignados";

    protected override async Task OnInitializedAsync()
    {
        var responseHttp = await _repository.GetAsync<SexoAsignado>($"{BaseUrl}/{Id}");
    ...
    {
        var responseHttp = await _repository.PutAsync($"{BaseUrl}", SexoAsignados);
