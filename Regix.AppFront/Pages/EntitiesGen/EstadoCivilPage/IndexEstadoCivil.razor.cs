...
public partial class IndexEstadoCivil
{
    ...
    public List<EstadoCivil>? EstadoCivils { get; set; }
    ...
    private async Task Cargar(int page = 1)
    {
        ...
        var responseHttp = await _repository.GetAsync<List<EstadoCivil>>(url);
    ...
    private async Task ShowModalAsync(int id = 0, bool isEdit = false)
    {
        if (isEdit)
        {
            ...
            await _modalService.ShowAsync<EditEstadoCivil>(parameters);
        }
        else
        {
            var parameters = new Dictionary<string, object>
            ...
            await _modalService.ShowAsync<CreateEstadoCivil>(parameters);
        }
    }
