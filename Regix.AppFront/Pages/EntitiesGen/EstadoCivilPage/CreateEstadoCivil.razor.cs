...
public partial class CreateEstadoCivil
{
    //Services
    ...
    private EstadoCivil EstadoCivil = new() { Active = true };
    private string BaseUrl = "/api/v1/estadosciviles";
    private string BaseView = "/estadosciviles";

    private async Task Create()
    {
        var responseHttp = await _repository.PostAsync($"{BaseUrl}", EstadoCivil);
