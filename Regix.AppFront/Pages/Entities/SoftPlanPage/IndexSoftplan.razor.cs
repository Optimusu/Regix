...
namespace Regix.AppFront.Pages.Entities.SoftPlanPage;
...
public partial class IndexSoftplan
{
    ...
    private async Task ShowModalAsync(int id = 0, bool isEdit = false)
    {
        if (isEdit)
        {
            ...
            await _modalService.ShowAsync<EditSoftPlan>(parameters);
        }
        else
        {
            var parameters = new Dictionary<string, object>
            ...
            await _modalService.ShowAsync<CreateSoftPlan>(parameters);
        }
    }
