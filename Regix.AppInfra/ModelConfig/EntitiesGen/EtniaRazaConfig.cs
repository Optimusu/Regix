...
public class EtniaRazaConfig : IEntityTypeConfiguration<EtniaRaza>
{
    public void Configure(EntityTypeBuilder<EtniaRaza> builder)
    {
        builder.HasKey(e => e.EtniaRazaId);
