...
namespace Regix.AppBack.Controllers.EntitiesGen
{
    ...
    {
        private readonly IIdiomaUnitOfWork _unitOfWork;
        private readonly IStringLocalizer _localizer;

        public IdiomasController(IIdiomaUnitOfWork unitOfWork, IStringLocalizer localizer)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> PutAsync(Idioma modelo)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<IActionResult> PostAsync(Idioma modelo)
        {
            try
            {
