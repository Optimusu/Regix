...
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/pharmacies")]
[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme, Roles = "Admin, Administrator")]
[ApiController]
public class PharmaciesController : ControllerBase
{
    private readonly IPharmacyUnitOfWork _unitOfWork;
    private readonly IStringLocalizer _localizer;

    public PharmaciesController(IPharmacyUnitOfWork unitOfWork, IStringLocalizer localizer)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> PutAsync(Pharmacy modelo)
    {
        try
        {
    ...
    [HttpPost]
    public async Task<IActionResult> PostAsync(Pharmacy modelo)
    {
        try
        {
