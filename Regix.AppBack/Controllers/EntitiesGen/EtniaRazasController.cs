...
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/etniarazas")]
[Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme, Roles = "Admin, Administrator")]
[ApiController]
public class EtniaRazasController : ControllerBase
{
    private readonly IEtniaRazaUnitOfWork _unitOfWork;
    private readonly IStringLocalizer _localizer;

    public EtniaRazasController(IEtniaRazaUnitOfWork unitOfWork, IStringLocalizer localizer)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> PutAsync(EtniaRaza modelo)
    {
        try
        {
    ...
    [HttpPost]
    public async Task<IActionResult> PostAsync(EtniaRaza modelo)
    {
        try
        {
