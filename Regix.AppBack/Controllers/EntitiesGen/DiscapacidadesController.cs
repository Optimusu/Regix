...
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/discapacidades")]
...
{
    private readonly IDiscapacidadUnitOfWork _unitOfWork;
    private readonly IStringLocalizer _localizer;

    public DiscapacidadesController(IDiscapacidadUnitOfWork unitOfWork, IStringLocalizer localizer)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> PutAsync(Discapacidad modelo)
    {
        try
        {
    ...
    [HttpPost]
    public async Task<IActionResult> PostAsync(Discapacidad modelo)
    {
        try
        {
