...
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/veterans")]
...
{
    private readonly IVeteranUnitOfWork _unitOfWork;
    private readonly IStringLocalizer _localizer;

    public VeteransController(IVeteranUnitOfWork unitOfWork, IStringLocalizer localizer)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> PutAsync(Veteran modelo)
    {
        try
        {
    ...
    [HttpPost]
    public async Task<IActionResult> PostAsync(Veteran modelo)
    {
        try
        {
