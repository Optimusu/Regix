...
{
    [ApiVersion("1.0")]
    [Route("api/v{version:apiVersion}/identidadgeneros")]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme, Roles = "Admin, Administrator")]
    [ApiController]
    public class IdentidadGenerosController : ControllerBase
    {
        private readonly IIdentidadGeneroUnitOfWork _unitOfWork;
        private readonly IStringLocalizer _localizer;

        public IdentidadGenerosController(IIdentidadGeneroUnitOfWork unitOfWork, IStringLocalizer localizer)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> PutAsync(IdentidadGenero modelo)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<IActionResult> PostAsync(IdentidadGenero modelo)
        {
            try
            {
